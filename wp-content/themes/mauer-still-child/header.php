			...
			<div class="col-xs-12">
				...
				<div class="menu-stripe-wrapper">
					...
					<nav class="navbar navbar-default navbar-static-top mauer-navbar">
						<!-- Commented out because not in design -->
						...
						<div id="navbar" class="navbar-collapse collapse">
							...
							<!-- <?php 
							// No icons in design so removed
							
							//if (function_exists('get_field') && (get_field('search_icon_in_header','option') || get_field('social_links', 'option'))): ?> -->
